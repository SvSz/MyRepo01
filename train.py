...
if __name__ == "__main__":
    ...
    #if config.GPU_ID != -1:                    #### Deactivated if only 1 GPU is available
    #    ng.set_gpus(config.GPU_ID)            #### Deactivated if only 1 GPU is available
    #else:                                     #### Deactivated if only 1 GPU is available
    #    ng.get_gpus(config.NUM_GPUS)          #### Deactivated if only 1 GPU is available
    # training data
